        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url().'home/pay'; ?>" method="post" class="form-signin">
                        ...
                        <div class="form-label-group">
                            ...
                            <input type="text" name="address" id="address" class="form-control" placeholder="Name"  required >
                        </div> <br/>
